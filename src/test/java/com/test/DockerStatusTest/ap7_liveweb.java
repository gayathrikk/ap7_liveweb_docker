...
public class ap7_liveweb {
    ...
    public void Live_Web_Status() {
        ...
        try {
            ...
            if (!isRunning) {
                sendEmailAlert("Hi,\n\n🚨 This is ap7 LiveWeb Docker. I am currently down. Kindly restart the container at your earliest convenience.");
    ...
    public void sendEmailAlert(String messageBody) {
        ...
        String subject = "Docker Container Alert - ap7 LiveWeb";
